...
Python solutions of Google Code Jam 2018. Solution begins with `*` means it will get TLE in the hardest data set (total computation amount > `10^8`, which is not friendly for Python to solve).
