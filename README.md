...
|B| [Two-Tiling](https://codingcompetitions.withgoogle.com/codejam/round/0000000000007766/000000000004da97)| [Python](./World%20Finals/two-tiling.py) | _O((1+8+8+65)^(N^2))_ | Space: _O(2^(2 * M^2 - 1) * N^2)_ | Hard | | Backtracking, Bit Manipulation, Union Find, Precompute |
